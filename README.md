## V1: Redesign the Current Linux.do Connect Authorization Page

| Original | Re-designed Version |
|------|--------------|
...
## V4: Improving the Animations to the Button "Autorization" (much more natural):
